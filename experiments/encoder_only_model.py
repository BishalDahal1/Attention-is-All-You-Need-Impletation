...
# 
with open('Algorithm From Scratch/zDEEP_LEARNING/input.txt', 'r', encoding='utf-8') as f:
    text = f.read()
...
class Block(nn.Module):
    def __init__(self, n_embd , n_head):
        ...
        self.sa = MultiHeadSelfAttentation(n_head, head_size)
...
class BigramLanguageModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.sa_head = MultiHeadSelfAttentation(4 , n_embd//4)
